...
class ResumeServicesImpTest {
    ...
    void queryResumeByUserId() {
        List<Resume> resumeList = resumeServicesImp.queryResumeByUserId(111);
    ...
    @Autowired
    ICollectServicesImpl collectServices;
    @Test
    void queryUserCollectJob() {
        PageInfo<Job> jobPageInfo = collectServices.queryUserCollectJob(null, 1);
        System.out.println(jobPageInfo);
    }
}