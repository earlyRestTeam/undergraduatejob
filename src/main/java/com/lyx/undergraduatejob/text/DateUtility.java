 ...
 * 2020/7/17 1.0 liyouxian Creation File
 */
package
...
public class DateUtility {
    ...
    public static LocalTime stringToLocalTime(String value) {
        if (value == null)
            return null;
        DateTimeFormatter formatter = DateTimeFormatter.ofPattern(LONG_TIME_FORMAT);
        LocalTime localTime = null;
        try {
            localTime= LocalTime.parse(value, formatter);
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public static LocalDateTime stringToLongLocalDateTime(String value) {

        return stringToLocalDateTime(value, FULL_DATE_TIME_FORMAT);
    }
