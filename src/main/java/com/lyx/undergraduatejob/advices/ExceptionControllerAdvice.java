...
import com.lyx.undergraduatejob.utils.WebCode;
import com.lyx.undergraduatejob.utils.WebUtils;
...
//    @ExceptionHandler(ShiroException.class)
    ...
    public Object globalException(HttpServletRequest request, HandlerMethod handlerMethod, Throwable ex) {
        if(WebUtils.isAjax(handlerMethod)){
            ...
            modelAndView.setViewName("error_page.html"); //这里需要在templates文件夹下新建一个/error/500.html文件用作错误页面
